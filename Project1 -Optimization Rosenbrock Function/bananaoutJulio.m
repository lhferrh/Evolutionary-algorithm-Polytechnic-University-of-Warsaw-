...
switch state
    case 'init'
       ...
       plot3(-1.97,-1.57,267.62,'ko','MarkerSize',15,'LineWidth',2);
       text(-1.5,-1.74,267.62,'   Start','Color',[0 0 0]);
       plot3(-0.784,-0.988,0,'ko','MarkerSize',15,'LineWidth',2);
       text(-0.575,-0.4,0,'   Solution','Color',[0 0 0]);
       drawnow
