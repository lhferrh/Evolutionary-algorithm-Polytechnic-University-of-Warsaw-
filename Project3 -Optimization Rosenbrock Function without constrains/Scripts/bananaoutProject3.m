function [stop,options,optchanged] = bananaoutProject3(optimvalues,options,flag)
    ...
    case 'iter'
        last;
        if ( optimvalues.iteration< 100 )||( mod(optimvalues.iteration,60)==0 && optimvalues.iteration<15000 ) || ( mod(optimvalues.iteration,5000)==0 )
            x1 = last(1);
            y1 = last(2);
            z1 = f(x1,y1);
